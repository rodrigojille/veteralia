...
export default function HeroSection() {
  return (
    <Box sx={{ bgcolor: 'primary.main', color: 'white', py: { xs: 8, md: 12 }, borderRadius: 3, mt: 4, mb: 8, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      <Container maxWidth="md" sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', px: { xs: 1, sm: 2 } }}>
        <Box
          component="img"
          src="/logo.png"
          alt="Veteralia Logo"
